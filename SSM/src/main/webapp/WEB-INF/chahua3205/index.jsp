...
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/bootstrap.css" type="text/css" media="screen">
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/responsive.css" type="text/css" media="screen">
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/style.css" type="text/css" media="screen">
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/inner.css" type="text/css" media="screen">
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/demo/switcher.css" type="text/css" media="screen">
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/es-carousel.css" type="text/css" media="screen">
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/prettyphoto.css" type="text/css" media="screen">
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/footer-color.css" type="text/css" media="screen">
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/color1.css" type="text/css" id="theme" />
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/footer-color.css" type="text/css" media="screen">
<!-- CSS STYLE -->
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/rs-plugin/style.css" type="text/css" media="screen" />
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/rs-plugin/preview.css" type="text/css" media="screen" />
<!-- REVOLUTION BANNER CSS SETTINGS -->
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/rs-plugin/settings.css" type="text/css" media="screen" />
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/rs-plugin/captions.css" type="text/css" media="screen" />
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/portfolio.css" type="text/css" media="screen">
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/portfolio-shape.css" type="text/css" media="screen">
<link rel="stylesheet" href="${contextPath}/ssm/chahua3205/css/elements.css" type="text/css" media="screen">
...
<div id="wrapper">
          ...
          <div class="row">
            <div class="span12">
              <ul class="thumbnails thumbnails_2">
                <li class="span3">
                  <div class="thumbnail_2"> <img src="${contextPath}/ssm/chahua3205/img/icons/top-icon1.png" alt="">
                    <div>
                ...
                <li class="span3">
                  <div class="thumbnail_2"> <img alt="" src="${contextPath}/ssm/chahua3205/img/icons/top-icon2.png">
                    <div>
                ...
                <li class="span3">
                  <div class="thumbnail_2"> <img src="${contextPath}/ssm/chahua3205/img/icons/top-icon3.png" alt="">
                    <div>
                      <h2>Clean Design</h2>
                      <p class="">Lorem ipsum dolor sit amet, conse ctetuer adipiscing elit, sed diam nonu mmy nibh euismodt. Lorem ipsum dolor sit amet.</p>
                    </div>
                ...
                <li class="span3">
                  <div class="thumbnail_2"> <img src="${contextPath}/ssm/chahua3205/img/icons/top-icon4.png" alt="">
                    <div>
                      <h2>Need Help</h2>
                      <p class="">Lorem ipsum dolor sit amet, conse ctetuer adipiscing elit, sed diam nonu mmy nibh euismodt. Lorem ipsum dolor sit amet.</p>
                    </div>
    ...
    <header>
      <div class="container clearfix">
        <div class="row ">
          <div class="span12">
            <!-- Logo -->
            <h1 class="brand brand_"><a href="index.html"><img src="${contextPath}/ssm/chahua3205/img/logo.png" alt=""></a></h1>
            <!-- Navigation -->
  ...
  <div class="fullwidthbanner-container">
    ...
    <div class="fullwidthabnner">
      <ul>
        <!-- THE 1 SLIDE -->
        <li data-transition="slidehorizontal" data-slotamount="7" data-masterspeed="300" data-delay="9500" > <img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/bg/1.jpg" >
          <div class="tp-caption lfb"  
					 data-x="0" 
					 data-y="22" 
					 data-speed="1000" 
					 data-start="500" 
					 data-easing="easeInOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/lap.png" alt="Image 1"></div>
          <div class="tp-caption lft"  
					 data-x="146" 
					 data-y="115" 
					 data-speed="1500" 
					 data-start="800" 
					 data-easing="easeInOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/s-big.png" alt="Image 2"></div>
          <div class="tp-caption lfb"  
					 data-x="249" 
					 data-y="193" 
					 data-speed="1500" 
					 data-start="1100" 
					 data-easing="easeInOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/u.png" alt="Image 3"></div>
          <div class="tp-caption lft"  
					 data-x="305" 
					 data-y="193" 
					 data-speed="1500" 
					 data-start="1400" 
					 data-easing="easeInOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/c.png" alt="Image 4"></div>
          <div class="tp-caption lfb"  
					 data-x="345" 
					 data-y="193" 
					 data-speed="1500" 
					 data-start="1700" 
					 data-easing="easeInOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/c.png" alt="Image 5"></div>
          <div class="tp-caption lft"  
					 data-x="387" 
					 data-y="193" 
					 data-speed="1500" 
					 data-start="2000" 
					 data-easing="easeInOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/e.png" alt="Image 8"></div>
          <div class="tp-caption lfb"  
					 data-x="421" 
					 data-y="187" 
					 data-speed="1500" 
					 data-start="2300" 
					 data-easing="easeInOutBounce"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/s.png" alt="Image 9"></div>
          <div class="tp-caption lft"  
					 data-x="449" 
					 data-y="187" 
					 data-speed="1500" 
					 data-start="2600" 
					 data-easing="easeInOutBounce"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/s-last.png" alt="Image 9"></div>
        ...
        <!-- THE 2 SLIDE -->
        <li data-transition="papercut" data-slotamount="10"> <img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/bg/2.jpg">
          <div class="caption lft" data-x="-70" data-y="-30" data-speed="900" data-start="900" data-easing="easeOutExpo"><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/glare.png"></div>
          <div class="caption lfl" data-x="-60" data-y="10" data-speed="900" data-start="1300" data-easing="easeOutBack"><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/man4.png"></div>
          ...
          <div class="caption sfl" data-x="510" data-y="180" data-speed="300" data-start="2600" data-easing="easeOutExpo"><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/check.png"></div>
          ...
          <div class="caption sfl" data-x="510" data-y="230" data-speed="300" data-start="2900" data-easing="easeOutExpo"><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/check.png"></div>
          ...
          <div class="caption sfl" data-x="510" data-y="280" data-speed="300" data-start="3200" data-easing="easeOutExpo"><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/check.png"></div>
        ...
        <!-- THE 3 SLIDE -->
        <li data-transition="fade" data-slotamount="7" data-masterspeed="300" > <img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/bg/3.jpg" alt="bgslider-blue" data-fullwidthcentering="true">
          <div class="tp-caption sfl"  
					 data-x="-1" 
					 data-y="30" 
					 data-speed="300" 
					 data-start="700" 
					 data-easing="easeOutBack"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/slideimg1.png" alt="Image 1"></div>
          <div class="tp-caption fade"  
					 data-x="551" 
					 data-y="167" 
					 data-speed="300" 
					 data-start="1100" 
					 data-easing="easeOutBack"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/success.png" alt="Image 2"></div>
          <div class="tp-caption sfr"  
					 data-x="495" 
					 data-y="120" 
					 data-speed="300" 
					 data-start="1300" 
					 data-easing="easeOutBack"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/inclined.png" alt="Image 3"></div>
          ...
          <div class="tp-caption sfr"  
					 ...
					 data-speed="300" 
					 data-start="1700" 
					 data-easing="easeOutBack"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/horizontal.png" alt="Image 6"></div>
          <div class="tp-caption sfr"  
					 data-x="720" 
					 data-y="240" 
					 data-speed="300" 
					 data-start="2800" 
					 data-easing="easeOutBack"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/rightalign.png" alt="Image 7"></div>
          <div class="tp-caption sfr"  
					 data-x="721" 
					 data-y="115" 
					 data-speed="300" 
					 data-start="4000" 
					 data-easing="easeOutBack"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/rightupperalign.png" alt="Image 8"></div>
          <div class="tp-caption sfr"  
					 data-x="519" 
					 data-y="242" 
					 data-speed="300" 
					 data-start="2200" 
					 data-easing="easeOutBack"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/leftloweralign.png" alt="Image 9"></div>
          <div class="tp-caption bold_red_text sft"  
					 data-x="330" 
					 data-y="268" 
					 data-speed="300" 
          ...
          <div class="tp-caption sft"  
					 ...
					 data-speed="300" 
					 data-start="3400" 
					 data-easing="easeOutBack"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/horizontal2.png" alt="Image 13"></div>
          <div class="tp-caption bold_red_text sft"  
					 data-x="841" 
					 data-y="179" 
					 data-speed="300" 
        ...
        <!-- THE 4 SLIDE -->
        <li data-transition="fade" data-slotamount="7" data-masterspeed="300" > <img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/bg/4.jpg" alt="bgslider-blue2" data-fullwidthcentering="true">
          <div class="tp-caption sfl"  
					 data-x="27" 
					 data-y="17" 
					 data-speed="300" 
					 data-start="500" 
					 data-easing="easeOutExpo"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/girl2.png" alt="Image 2"></div>
          <div class="tp-caption big_colorbg sfr"  
					 data-x="437" 
					 data-y="97" 
					 data-speed="300" 
          ...
          <div class="tp-caption sfb"  
					 ...
					 data-speed="900" 
					 data-start="1400" 
					 data-easing="easeOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/chrome.png" alt="Image 5"></div>
          <div class="tp-caption sfb"  
					 data-x="610" 
					 data-y="210" 
					 data-speed="900" 
					 data-start="1700" 
					 data-easing="easeOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/firefox.png" alt="Image 6"></div>
          <div class="tp-caption sfb"  
					 data-x="774" 
					 data-y="206" 
					 data-speed="900" 
					 data-start="2000" 
					 data-easing="easeOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/ie.png" alt="Image 7"></div>
        </li>
        <!-- THE 5 SLIDE -->
        <li data-transition="papercut" data-slotamount="7" data-masterspeed="300" > <img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/bg/5.jpg" alt="bgslider-blue" data-fullwidthcentering="true">
          <div class="tp-caption sfb"  
					 data-x="58" 
					 data-y="85" 
					 data-speed="900" 
					 data-start="500" 
					 data-easing="easeInOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/orange.png" alt="Image 1"></div>
          <div class="tp-caption sfb"  
					 data-x="272" 
					 data-y="196" 
					 data-speed="1900" 
					 data-start="800" 
					 data-easing="easeInOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/blue.png" alt="Image 3"></div>
          <div class="tp-caption sfb"  
					 data-x="116" 
					 data-y="211" 
					 data-speed="300" 
					 data-start="1100" 
					 data-easing="easeInOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/green.png" alt="Image 2"></div>
          <div class="tp-caption sft"  
					 data-x="242" 
					 data-y="14" 
					 data-speed="300" 
					 data-start="1400" 
					 data-easing="easeInExpo"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/tooltip-60.png" alt="Image 4"></div>
          <div class="tp-caption lft"  
					 data-x="251" 
					 data-y="164" 
					 data-speed="600" 
					 data-start="1700" 
					 data-easing="easeInBounce"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/tooltip-30.png" alt="Image 5"></div>
          <div class="tp-caption lft"  
					 data-x="407" 
					 data-y="142" 
					 data-speed="600" 
					 data-start="2000" 
					 data-easing="easeInBounce"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/tooltip-10.png" alt="Image 6"></div>
        ...
        <!-- THE 6 SLIDE -->
        <li data-transition="fade" data-slotamount="7" data-masterspeed="300" > <img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/bg/6.jpg" alt="bgslider-blue2" data-fullwidthcentering="true">
          <div class="tp-caption sfb"  
					 data-x="0" 
					 data-y="65" 
					 data-speed="1300" 
          ...
          <div class="tp-caption sfb"  
					 ...
					 data-speed="900" 
					 data-start="1400" 
					 data-easing="easeOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/youtube-logo.png" alt="Image 5"></div>
          <div class="tp-caption sfb"  
					 data-x="710" 
					 data-y="210" 
					 data-speed="900" 
					 data-start="2100" 
					 data-easing="easeOutElastic"  ><img src="${contextPath}/ssm/chahua3205/img/rs-slider/slides/vimeo-logo.png" alt="Image 6"></div>
        </li>
      </ul>
          ...
          <div class="img-border">
            <div class="img-slidewrap">
              ...
              <ul class="img-slider" id="imgslider">
                <li class="img-slide"> <img src="${contextPath}/ssm/chahua3205/img/page1-img2.jpg" alt=""/>
                ...
                <li class="img-slide"> <img src="${contextPath}/ssm/chahua3205/img/page1-img3.jpg" alt=""/>
                  <ul class="team-social">
                    <li class="twitter-team"><a href="#">Twitter</a></li>
                    <li class="facebook-team"><a href="#">Facebook</a></li>
                    <li class="dribbble-team"><a href="#">Dribbble</a></li>
                ...
                <li class="img-slide"> <img src="${contextPath}/ssm/chahua3205/img/page1-img4.jpg" alt=""/>
                  <ul class="team-social">
                    <li class="twitter-team"><a href="#">Twitter</a></li>
                    <li class="facebook-team"><a href="#">Facebook</a></li>
                    <li class="dribbble-team"><a href="#">Dribbble</a></li>
        ...
        <div class="row">
          ...
          <div class="span3">
            ...
            <ul id="social" class="tooltip-demo">
              <li><a rel="tooltip" title="RSS" href="#"><img alt="RSS" src="${contextPath}/ssm/chahua3205/img/social_icons/rss.png"></a></li>
              <li><a rel="tooltip" title="Twitter" href="#"><img alt="Twitter" src="${contextPath}/ssm/chahua3205/img/social_icons/twitter.png"></a></li>
              <li><a rel="tooltip" title="Facebook" href="#"><img alt="Facebook" src="${contextPath}/ssm/chahua3205/img/social_icons/facebook.png"></a></li>
              <li><a rel="tooltip" title="Dribbble" href="#"><img alt="Dribbble" src="${contextPath}/ssm/chahua3205/img/social_icons/dribbble.png"></a></li>
              <li><a rel="tooltip" title="Flickr" href="#"><img alt="Flickr" src="${contextPath}/ssm/chahua3205/img/social_icons/flickr.png"></a></li>
              <li><a rel="tooltip" title="Skype" href="#"><img alt="Skype" src="${contextPath}/ssm/chahua3205/img/social_icons/skype.png"></a></li>
            </ul>
            </address>
          </div>
          <!-- Useful Links -->
...
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.js"></script>
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/bootstrap.js"></script>
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/custom.js"></script>
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.sliderTabs.js"></script>
<!-- jQuery Slider  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/rs-plugin/jquery.themepunch.plugins.min.js"></script>
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/rs-plugin/jquery.themepunch.revolution.min.js"></script>
<!-- Elastislider  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.elastislide.js"></script>
<!-- Pretty photo  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.prettyphoto.js"></script>
<!-- Carousel  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/carousel.js"></script>
<!-- totop  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.ui.totop.js"></script>
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/prettify.js"></script>
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/application.js"></script>
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.cookie.js"></script>
<!-- Quicksand  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.quicksand.js"></script>
<!-- Image animated Style  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.gridrotator.js"></script>
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.mobile.customized.min.js"></script>
<!-- Accordion  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/accordion.js"></script>
<!-- Tabs  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/tabs.js"></script>
<!-- Sitemap  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/sitemap.js"></script>
<!-- Navigation  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/nav-small.js"></script>
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.mobilemenu.js"></script>
<!-- Isotope  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/jquery.isotope.min.js"></script>
<!-- Metro Style  -->
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/js/boxgrid.js"></script>
<script type="text/javascript" src="${contextPath}/ssm/chahua3205/demo/switcher.js"></script>
<!-- Elastislider  -->
<script>
